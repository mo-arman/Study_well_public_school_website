    ...
    <>
      ...
      <div className="container-custom py-16 max-w-sm">
        <form className="space-y-4">
          <input className="w-full border border-mist rounded-lg px-4 py-3 text-sm" placeholder="Registered Mobile Number" />
        ...
        <p className="text-navy-ink/50 text-xs mt-6">
          TODO: Connect to an actual ERP provider or custom auth backend. Parents typically need attendance, homework, and fee views here.
        </p>
      </div>
    </>
  );
